...
{{--                                <option >select a supplier</option>--}}
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            <label for="address">Dept</label>
                            <div class="custom-control custom-radio">
                                <input type="radio" id="dept_yes" ${data.is_dept===1?'checked':null}  name="is_dept" value="1" class="custom-control-input">
                                <label class="custom-control-label" for="dept_yes">Yes</label>
                            </div>
                            <div class="custom-control custom-radio">
                                <input type="radio" id="dept_no" name="is_dept"  ${data.is_dept===0?'checked':null} value="0" class="custom-control-input">
                                <label class="custom-control-label" for="dept_no">No</label>
                            </div>
                        </div>
                    </form>
